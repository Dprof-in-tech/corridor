  ...
  return (
    <Shell>
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        ...
        <Action href="/app/bob-to-nigeria"  tag="Bolivia → Nigeria" title="Pay a Nigerian bank in BOB" sub="Scan one BOB QR; naira lands in their bank. USDC never stops in between." />
        <Action href="/app/request-naira"   tag="Nigeria → Bolivia" title="Receive naira as BOB" sub="Share a link; a Nigerian pays by bank transfer, bolivianos land in your bank." />
